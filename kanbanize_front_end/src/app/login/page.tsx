...
// Um componente simples para a ilustração (opcional, mas ajuda a organizar)
const Illustration = () => (
  <div className="w-full h-full flex flex-col items-center justify-center text-white p-10">
    {/* Você pode substituir este div por uma tag <img /> ou um componente SVG */}
    <div className="w-4/5 h-auto mb-6">
        {/* SUGESTÃO: Use uma ilustração de undraw.co, storyset.com, etc. */}
        {/* Exemplo de SVG inline para demonstração */}
...
export default function LoginPage() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    // ... sua lógica de handleSubmit continua a mesma
    e.preventDefault();
    if (!email || !senha) {
